...
function strMapToObj(strMap) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _step$value = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__.default)(_step.value, 2),
        k = _step$value[0],
        v = _step$value[1];
...
function toAxisRequest(obj) {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var _step2$value = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__.default)(_step2.value, 2),
        key = _step2$value[0],
...
function _getContent() {
  _getContent = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(obj) {
    var content;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return axiosInstance.request(toAxisRequest(obj));
        case 2:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return loadPyodide();
        case 2:
          self.pyodide = _context2.sent;
          _context2.next = 5;
          return self.pyodide.loadPackage(['micropip']);
        case 5:
          _context2.next = 7;
          return self.pyodide.runPython("import micropip;micropip.install(['dothttp-req-wasm==0.0.43a23', 'setuptools'])");
        case 7:
          _context2.next = 9;
          return self.pyodide.runPython(loadCode);
        case 9:
          self.postMessage({
            key: _utils_utils__WEBPACK_IMPORTED_MODULE_3__.KIND.LOADED
          });
        case 10:
        case "end":
...
function _executeAndUdate() {
  _executeAndUdate = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(code, target) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 4;
          _context3.next = 7;
          return (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.getContent)(out);
        case 7:
          resp = _context3.sent;
          contentType = resp.headers['content-type'];
          if (contentType === "application/json") {} else {
            lang = "text";
          }
          status = resp.status;
          content = resp.data;
        ...
        case 14:
          ...
          content = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.formatJson)(_context3.t0);
          status = 500;
        case 18:
...
self.onmessage = /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          _event$data = event.data, key = _event$data.key, code = _event$data.code, uniqKey = _event$data.uniqKey, context = (0,_babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_1__.default)(_event$data, _excluded);
          console.log(key, code, context);
          _context.prev = 4;
          if (!(key === _utils_utils__WEBPACK_IMPORTED_MODULE_3__.KIND.EXECUTE)) {
            _context.next = 11;
            break;
          }
          _context.next = 8;
        ...
        case 8:
          ...
          break;
        case 11:
          if (!(key === _utils_utils__WEBPACK_IMPORTED_MODULE_3__.KIND.TARGETS)) {
            _context.next = 17;
            break;
          }
          _context.next = 14;
          return getTargets(code);
        case 14:
          results = _context.sent;
          _context.next = 18;
          break;
        case 17:
          results = {
            error: true,
            error_message: "key not supported"
          };
        case 18:
          _context.next = 23;
          break;
        case 20:
          ...
          results = {
            error: true,
            error_message: "execution error happened"
          };
        case 23:
          self.postMessage({
            results: results,
...
/******/ })()
;
//# sourceMappingURL=dothttp.worker.bundle.js.map